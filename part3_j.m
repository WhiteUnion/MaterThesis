...
maxMy5_406s_mean=max(maxMy5_406s);
...
maxMy5H1H2_406s_mean=max(maxMy5H1H2_406s);
...
legend('1h','Max-1h','Max-406s,H_{max}','Max-406s,1st/2nd H_{max}',...
    'Ex-Max-1h','Ex-Max-406s,H_{max}','Ex-Max-406s,1st/2nd H_{max}','Location','northeast')
...
axis([-inf inf 0 20])
legend('Histogram','Max-1h','Location','northeast')
...
axis([-inf inf 0 20])
legend('Histogram','Max-406s,H_{max}','Location','northeast')
xlabel('Maximum FA-moment [kNm]')
grid on
grid minor
...
axis([-inf inf 0 20])
legend('Histogram','Max-406s,1st/2nd H_{max}','Location','northeast')
xlabel('Maximum FA-moment [kNm]')
grid on
grid minor